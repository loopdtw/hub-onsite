...
angular.module("pageslide-directive",[]).directive("pageslide",["$document","$timeout",function(e,t){return{restrict:"EAC",transclude:!1,scope:{psOpen:"=?",psAutoClose:"=?",psSide:"@",psSpeed:"@",psClass:"@",psSize:"@",psSqueeze:"@",psCloak:"@",psPush:"@",psContainer:"@",psKeyListener:"@",psBodyClass:"@"},link:function(s,o,i){function l(e){if(y.bodyClass){var t=y.className+"-body",s=new RegExp(" "+t+"-closed| "+t+"-open");d.className=d.className.replace(s,""),d.className+=" "+t+"-"+e}}function p(t,o){if(t&&0!==t.style.width)switch(o.cloak&&r.css("display","none"),o.side){case"right":t.style.width="0px",o.squeeze&&(d.style.right="0px"),o.push&&(d.style.right="0px",d.style.left="0px");break;case"left":t.style.width="0px",o.squeeze&&(d.style.left="0px"),o.push&&(d.style.left="0px",d.style.right="0px");break;case"top":t.style.height="0px",o.squeeze&&(d.style.top="0px"),o.push&&(d.style.top="0px",d.style.bottom="0px");break;case"bottom":t.style.height="0px",o.squeeze&&(d.style.bottom="0px"),o.push&&(d.style.bottom="0px",d.style.top="0px")}s.psOpen=!1,o.keyListener&&e.off("keydown",a),l("closed")}function n(o,i){if(0!==o.style.width){switch(i.side){case"right":o.style.width=i.size,i.squeeze&&(d.style.right=i.size),i.push&&(d.style.right=i.size,d.style.left="-"+i.size);break;case"left":o.style.width=i.size,i.squeeze&&(d.style.left=i.size),i.push&&(d.style.left=i.size,d.style.right="-"+i.size);break;case"top":o.style.height=i.size,i.squeeze&&(d.style.top=i.size),i.push&&(d.style.top=i.size,d.style.bottom="-"+i.size);break;case"bottom":o.style.height=i.size,i.squeeze&&(d.style.bottom=i.size),i.push&&(d.style.bottom=i.size,d.style.top="-"+i.size)}t(function(){i.cloak&&r.css("display","block")},1e3*i.speed),s.psOpen=!0,i.keyListener&&e.on("keydown",a),l("open")}}function a(e){var t=27,s=e.keyCode||e.which;s===t&&p(h,y)}var y={};y.side=s.psSide||"right",y.speed=s.psSpeed||"0.5",y.size=s.psSize||"300px",y.zindex=1e3,y.className=s.psClass||"ng-pageslide",y.cloak=!s.psCloak||"false"!=s.psCloak.toLowerCase(),y.squeeze=Boolean(s.psSqueeze)||!1,y.push=Boolean(s.psPush)||!1,y.container=s.psContainer||!1,y.keyListener=Boolean(s.psKeyListener)||!1,y.bodyClass=s.psBodyClass||!1,o.addClass(y.className);var r=null,h=null,d=y.container?document.getElementById(y.container):document.body;if(l("closed"),h=o[0],"div"!==h.tagName.toLowerCase()&&"pageslide"!==h.tagName.toLowerCase())throw new Error("Pageslide can only be applied to <div> or <pageslide> elements");if(0===h.children.length)throw new Error("You have to content inside the <pageslide>");switch(r=angular.element(h.children),d.appendChild(h),h.style.zIndex=y.zindex,h.style.position=y.container!==!1?"absolute":"fixed",h.style.width=0,h.style.height=0,h.style.overflow="hidden",h.style.transitionDuration=y.speed+"s",h.style.webkitTransitionDuration=y.speed+"s",h.style.transitionProperty="width, height",y.squeeze&&(d.style.position="absolute",d.style.transitionDuration=y.speed+"s",d.style.webkitTransitionDuration=y.speed+"s",d.style.transitionProperty="top, bottom, left, right"),y.side){case"right":h.style.height=i.psCustomHeight||"100%",h.style.top=i.psCustomTop||"0px",h.style.bottom=i.psCustomBottom||"0px",h.style.right=i.psCustomRight||"0px";break;case"left":h.style.height=i.psCustomHeight||"100%",h.style.top=i.psCustomTop||"0px",h.style.bottom=i.psCustomBottom||"0px",h.style.left=i.psCustomLeft||"0px";break;case"top":h.style.width=i.psCustomWidth||"100%",h.style.left=i.psCustomLeft||"0px",h.style.top=i.psCustomTop||"0px",h.style.right=i.psCustomRight||"0px";break;case"bottom":h.style.width=i.psCustomWidth||"100%",h.style.bottom=i.psCustomBottom||"0px",h.style.left=i.psCustomLeft||"0px",h.style.right=i.psCustomRight||"0px"}s.$watch("psOpen",function(e){e?n(h,y):p(h,y)}),s.$watch("psSize",function(e,t){t!==e&&(y.size=e,n(h,y))}),s.$on("$destroy",function(){d.removeChild(h)}),s.psAutoClose&&(s.$on("$locationChangeStart",function(){p(h,y)}),s.$on("$stateChangeStart",function(){p(h,y)}))}}}]);
!function(n,e,t){"use strict";function o(n){return e.lowercase(n.nodeName||n[0]&&n[0].nodeName)}function c(n,t){var o=!1,c=!1;this.ngClickOverrideEnabled=function(i){return e.isDefined(i)?(i&&!c&&(c=!0,u.$$moduleName="ngTouch",t.directive("ngClick",u),n.decorator("ngClickDirective",["$delegate",function(n){if(o)n.shift();else for(var e=n.length-1;e>=0;){if("ngTouch"===n[e].$$moduleName){n.splice(e,1);break}e--}return n}])),o=i,this):o},this.$get=function(){return{ngClickOverrideEnabled:function(){return o}}}}function i(n,t,o){r.directive(n,["$parse","$swipe",function(c,i){var r=75,u=.3,a=30;return function(s,l,h){function f(n){if(!d)return!1;var e=Math.abs(n.y-d.y),o=(n.x-d.x)*t;return v&&r>e&&o>0&&o>a&&u>e/o}var d,v,g=c(h[n]),p=["touch"];e.isDefined(h.ngSwipeDisableMouse)||p.push("mouse"),i.bind(l,{start:function(n,e){d=n,v=!0},cancel:function(n){v=!1},end:function(n,e){f(n)&&s.$apply(function(){l.triggerHandler(o),g(s,{$event:e})})}},p)}}])}var r=e.module("ngTouch",[]);r.provider("$touch",c),c.$inject=["$provide","$compileProvider"],r.factory("$swipe",[function(){function n(n){var e=n.originalEvent||n,t=e.touches&&e.touches.length?e.touches:[e],o=e.changedTouches&&e.changedTouches[0]||t[0];return{x:o.clientX,y:o.clientY}}function t(n,t){var o=[];return e.forEach(n,function(n){var e=c[n][t];e&&o.push(e)}),o.join(" ")}var o=10,c={mouse:{start:"mousedown",move:"mousemove",end:"mouseup"},touch:{start:"touchstart",move:"touchmove",end:"touchend",cancel:"touchcancel"}};return{bind:function(e,c,i){var r,u,a,s,l=!1;i=i||["mouse","touch"],e.on(t(i,"start"),function(e){a=n(e),l=!0,r=0,u=0,s=a,c.start&&c.start(a,e)});var h=t(i,"cancel");h&&e.on(h,function(n){l=!1,c.cancel&&c.cancel(n)}),e.on(t(i,"move"),function(e){if(l&&a){var t=n(e);if(r+=Math.abs(t.x-s.x),u+=Math.abs(t.y-s.y),s=t,!(o>r&&o>u))return u>r?(l=!1,void(c.cancel&&c.cancel(e))):(e.preventDefault(),void(c.move&&c.move(t,e)))}}),e.on(t(i,"end"),function(e){l&&(l=!1,c.end&&c.end(n(e),e))})}}}]);var u=["$parse","$timeout","$rootElement",function(n,t,c){function i(n,e,t,o){return Math.abs(n-t)<p&&Math.abs(e-o)<p}function r(n,e,t){for(var o=0;o<n.length;o+=2)if(i(n[o],n[o+1],e,t))return n.splice(o,o+2),!0;return!1}function u(n){if(!(Date.now()-l>g)){var e=n.touches&&n.touches.length?n.touches:[n],t=e[0].clientX,c=e[0].clientY;1>t&&1>c||f&&f[0]===t&&f[1]===c||(f&&(f=null),"label"===o(n.target)&&(f=[t,c]),r(h,t,c)||(n.stopPropagation(),n.preventDefault(),n.target&&n.target.blur&&n.target.blur()))}}function a(n){var e=n.touches&&n.touches.length?n.touches:[n],o=e[0].clientX,c=e[0].clientY;h.push(o,c),t(function(){for(var n=0;n<h.length;n+=2)if(h[n]==o&&h[n+1]==c)return void h.splice(n,n+2)},g,!1)}function s(n,e){h||(c[0].addEventListener("click",u,!0),c[0].addEventListener("touchstart",a,!0),h=[]),l=Date.now(),r(h,n,e)}var l,h,f,d=750,v=12,g=2500,p=25,m="ng-click-active";return function(t,o,c){function i(){f=!1,o.removeClass(m)}var r,u,a,l,h=n(c.ngClick),f=!1;o.on("touchstart",function(n){f=!0,r=n.target?n.target:n.srcElement,3==r.nodeType&&(r=r.parentNode),o.addClass(m),u=Date.now();var e=n.originalEvent||n,t=e.touches&&e.touches.length?e.touches:[e],c=t[0];a=c.clientX,l=c.clientY}),o.on("touchcancel",function(n){i()}),o.on("touchend",function(n){var t=Date.now()-u,h=n.originalEvent||n,g=h.changedTouches&&h.changedTouches.length?h.changedTouches:h.touches&&h.touches.length?h.touches:[h],p=g[0],m=p.clientX,w=p.clientY,$=Math.sqrt(Math.pow(m-a,2)+Math.pow(w-l,2));f&&d>t&&v>$&&(s(m,w),r&&r.blur(),e.isDefined(c.disabled)&&c.disabled!==!1||o.triggerHandler("click",[n])),i()}),o.onclick=function(n){},o.on("click",function(n,e){t.$apply(function(){h(t,{$event:e||n})})}),o.on("mousedown",function(n){o.addClass(m)}),o.on("mousemove mouseup",function(n){o.removeClass(m)})}}];i("ngSwipeLeft",-1,"swipeleft"),i("ngSwipeRight",1,"swiperight")}(window,window.angular);
angular.module("angular-duration-format.filter",[]).filter("duration",function(){function a(a){for(var r=[],e=a?a.toString():"";e;){var u=n.exec(e);u?(r=r.concat(u.slice(1)),e=r.pop()):(r.push(e),e=null)}return r}function r(a,r){var n="",t={};return r.filter(function(a){return u.hasOwnProperty(a)}).map(function(a){var r=u[a];return r.hasOwnProperty("pad")?r.value:a}).filter(function(a,r,e){return e.indexOf(a)===r}).map(function(a){return angular.extend({name:a},u[a])}).sort(function(a,r){return r.value-a.value}).forEach(function(r){var e=t[r.name]=Math.floor(a/r.value);a-=e*r.value}),r.forEach(function(a){var r=u[a];if(r){var l=t[r.value];n+=r.hasOwnProperty("pad")?e(l,Math.max(r.pad,l.toString().length)):t[a]}else n+=a.replace(/(^'|'$)/g,"").replace(/''/g,"'")}),n}function e(a,r){return(new Array(r+1).join("0")+a).slice(-r)}var n=/((?:[^ydhms']+)|(?:'(?:[^']|'')*')|(?:y+|d+|h+|m+|s+))(.*)/,u={y:{value:31536e6},yy:{value:"y",pad:2},d:{value:864e5},dd:{value:"d",pad:2},h:{value:36e5},hh:{value:"h",pad:2},m:{value:6e4},mm:{value:"m",pad:2},s:{value:1e3},ss:{value:"s",pad:2},sss:{value:1},ssss:{value:"sss",pad:4}};return function(e,n){var u=parseFloat(e,10),t=a(n);return isNaN(u)||0===t.length?e:r(u,t)}}),angular.module("angular-duration-format",["angular-duration-format.filter"]);
