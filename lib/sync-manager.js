...
exports.updateExistingBadges = function(badgeAddresses) {
    badgeAddresses.forEach(function(badgeAddress) {
        if(existingBadges[badgeAddress]) {
            allocatedPeripherals.del(badgeAddress);
            existingBadges[badgeAddress] = 1;
        }
    });
};
