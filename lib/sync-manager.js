...
function _connect(peripheral, mode) {
    ...
    peripheral.once('disconnect', function() {
        ...
        if (peripheral.status !== peripheralStatus.STATUS_NONE) {
...
exports.commandBadge = function(badge, badgeCommand) {
    return Promise.try(function() {
        var currentPeripheral = seenPeripherals[badge.identity + badge.macAddress];
        ...
        seenPeripherals[badge.identity + badge.macAddress].status = peripheralStatus.STATUS_COMMANDING;
