...
NobleBindings.prototype.onDiscover = function(status, address, addressType, connectable, advertisement, rssi, commandable) {
  ...
  if (hasScanServiceUuids) {
    ...
    this.emit('discover', uuid, address, addressType, connectable, advertisement, rssi, commandable);
  }
};
